...
<body>
	<form name="frm_consulta" id="frm_consulta" method="POST" action="consulta_gosto.php">
		<div class="container">
				...
				<div class="col-xs-12">
					<h3><img src="images/cbox.png"/>CBox </h3>
				  	<ul class="nav nav-tabs">
					    <li class="active"><a href="#" onclick="tabClick(0);">Consulta Empresa e/ou Profissao</a></li>
					    <li class=""><a href="#" onclick="tabClick(1);">Consulta de gostos</a></li>
				  	</ul>
				  	<br>
				</div>
			</div>	  
							...
							<div class="row">
								...
								<div class="col-xs-8">
									<select id="profession" class="form-control">
										<option></option>
										<option>Profissao1</option>
										<option>Profissao2</option>
										<option>Profissao3</option>
									</select>
								</div>
							</div>
							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									<tr>
										...
										<td class="text-left">Qualidade Catossi</td>
